...
\begin{wrapfigure}{r}{0.5\textwidth}
  \vspace*{-10pt} 
    \begin{tikzpicture}[scale=0.65, >=stealth]
        ...
        \tkzLabelPoint[right](1){\smaller $\vec{V}_{r1,gen}$};
        \node at (2)[circle,fill,inner sep=1.2pt]{};
        \tkzLabelPoint[right](2){\smaller $\vec{V}_{r2,gen}$};
        \node at (3)[circle,fill,inner sep=1.2pt]{};
        \tkzLabelPoint[above](3){\smaller $\vec{M}_{i,gen} = \vec{V}_{base,gen} + F (\vec{V}_{r1,gen} - \vec{V}_{r2,gen})$};
