...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Comparaison entre la courbe expérimentale (vert) et la caractéristique calculée (bleu)}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.45\textwidth}
...
\subsection{Analyse de cohérence}
